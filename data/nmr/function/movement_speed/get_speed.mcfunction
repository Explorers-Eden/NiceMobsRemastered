...
$execute if score $nmr_speed_choice nmr.technical matches 2 as @s store result storage nmr:speed base double 0.00001$(modifier_fast) run attribute @s minecraft:generic.movement_speed get 100000
