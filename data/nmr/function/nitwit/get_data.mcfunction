...
execute if score @s nmr.nitwit.entity matches 1..28 store result score @s nmr.nitwit.goal run random value 128..256
execute if score @s nmr.nitwit.entity matches 29..43 store result score @s nmr.nitwit.goal run random value 64..128
