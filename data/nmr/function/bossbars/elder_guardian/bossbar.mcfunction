...
$bossbar set nmr:elder_guardian_$(uuid_0)$(uuid_1)$(uuid_2)$(uuid_3) players @a[distance=..10]
$bossbar set nmr:elder_guardian_$(uuid_0)$(uuid_1)$(uuid_2)$(uuid_3) style notched_10
