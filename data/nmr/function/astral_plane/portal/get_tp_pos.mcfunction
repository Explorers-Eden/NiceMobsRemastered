...
execute as @a[tag=nmr_being_ported] at @s if entity @e[type=marker,tag=nmr_astral_plane_exit,distance=..1] if score @s nmr.astralplane.portal.pos.set matches 1 store result storage nmr:astralplane TempleX int 1 run scoreboard players get @s nmr.astralplane.portal.pos.x
execute as @a[tag=nmr_being_ported] at @s if entity @e[type=marker,tag=nmr_astral_plane_exit,distance=..1] if score @s nmr.astralplane.portal.pos.set matches 1 store result storage nmr:astralplane TempleY int 1 run scoreboard players get @s nmr.astralplane.portal.pos.y
execute as @a[tag=nmr_being_ported] at @s if entity @e[type=marker,tag=nmr_astral_plane_exit,distance=..1] if score @s nmr.astralplane.portal.pos.set matches 1 store result storage nmr:astralplane TempleZ int 1 run scoreboard players get @s nmr.astralplane.portal.pos.z
...
execute as @a[tag=nmr_being_ported] at @s unless data entity @s SpawnX if score @s nmr.astralplane.portal.pos.set matches 1 run function nmr:astral_plane/portal/teleport_temple with storage nmr:astralplane
execute as @a[tag=nmr_being_ported] at @s unless data entity @s SpawnX unless score @s nmr.astralplane.portal.pos.set matches 1 run function nmr:astral_plane/portal/teleport_relative with storage nmr:astralplane