...
execute as @e[type=marker,tag=nmr_celestial_watcher_spawn] at @s if score @s nmr.celestialwatcher.defeated matches 1 if entity @e[type=player,distance=..2] run function nmr:celestial_watcher/structure/portal/get_tp_pos
