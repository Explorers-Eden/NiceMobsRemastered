...
execute as @s at @s if predicate nmr:percentages/30percent run function nmr:boss/eye/give/celestial_turret

execute as @s at @s run advancement revoke @s only nmr:technical/celestial_turret