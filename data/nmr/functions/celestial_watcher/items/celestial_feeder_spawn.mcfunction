...
execute as @s at @s if predicate nmr:percentages/30percent run function nmr:boss/eye/give/celestial_feeder

execute as @s at @s run advancement revoke @s only nmr:technical/celestial_feeder
