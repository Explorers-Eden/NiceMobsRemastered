...
execute if score $nmr_shoot_1 nmr.technical matches 1 as @e[type=item_display,tag=nmr_headmob_addon_1] at @s run function nmr:celestial_watcher/entity/fireball_1
...
execute if score $nmr_shoot_2 nmr.technical matches 1 as @e[type=item_display,tag=nmr_headmob_addon_2] at @s run function nmr:celestial_watcher/entity/fireball_2
