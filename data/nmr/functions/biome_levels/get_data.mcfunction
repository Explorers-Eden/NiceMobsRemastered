...
$execute unless biome ~ ~ ~ #nmr:groups/default unless biome ~ ~ ~ #nmr:groups/flower run scoreboard players set $multiplier nmr.technical 1$(level)
...
execute store result score @s nmr.health.modified run scoreboard players operation @s nmr.health.base *= $175 nmr.technical
