title @s actionbar [{"text":"- ","color":"dark_gray","bold":false,"italic":false},{"text":"Region Level: 5-8","color":"#736C6C","bold":false,"italic":false},{"text":" -","color":"dark_gray","bold":false,"italic":false}]
