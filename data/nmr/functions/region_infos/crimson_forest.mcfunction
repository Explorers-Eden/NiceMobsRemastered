...
execute unless score @s region_info matches 1 run title @s actionbar [{"text":"- ","color":"dark_gray","bold":false,"italic":false},{"text":"Region Level: 77-80","color":"#736C6C","bold":false,"italic":false},{"text":" -","color":"dark_gray","bold":false,"italic":false}]
