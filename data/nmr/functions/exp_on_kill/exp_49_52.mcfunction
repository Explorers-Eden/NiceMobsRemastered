...
execute as @s store result storage nmr:exp count int 1 run random value 49..52
execute as @s at @s run function nmr:exp_on_kill/summon_exp with storage nmr:exp

execute as @s run advancement revoke @s only nmr:technical/exp_on_kill/exp_49_52