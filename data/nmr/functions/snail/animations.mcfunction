...
execute as @e[type=player] at @s unless entity @e[type=panda,tag=nmr_snail,distance=..48] run return fail
...
execute as @e[type=panda,tag=nmr_snail] at @s positioned ^ ^ ^-.2 if predicate nmr:percentages/20percent run particle dust 0.078 0.753 0.11 1 ~ ~ ~ .08 .08 .08 0 1
