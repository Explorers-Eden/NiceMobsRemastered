...
$execute store result bossbar nmr:golden_guardian_$(uuid_0)$(uuid_1)$(uuid_2)$(uuid_3) max run scoreboard players get @e[type=vex,limit=1,tag=$(uuid_0)$(uuid_1)$(uuid_2)$(uuid_3),sort=nearest] nmr.health.base
