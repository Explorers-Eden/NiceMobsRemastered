...
execute store result score @s nmr.nitwit.entity run random value 1..42
execute if score @s nmr.nitwit.entity matches 1..27 store result score @s nmr.nitwit.goal run random value 256..512
execute if score @s nmr.nitwit.entity matches 28..42 store result score @s nmr.nitwit.goal run random value 128..256
