execute as @e[type=player] at @s unless entity @e[type=item_display,tag=nmr_treasure_pig_head,distance=..48] run return fail
...
execute as @e[type=player] at @s unless entity @e[type=pig,tag=nmr_treasure_pig,distance=..48] run return fail
